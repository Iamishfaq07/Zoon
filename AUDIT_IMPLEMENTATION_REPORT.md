...
8. **"High confidence, no snoring" from 31 minutes of an 8-hour night**, headlined "0% of the night". `d38c152`, `122c900`
...
| §17.1–17.4, 17.6 UI redesign, §18 Sound Studio, §20 readiness, §21 room sound | Not done | Design work that needs looking at the result on a device; the audit orders it after P0/P1. §17.5 (unlock map) is done. |
