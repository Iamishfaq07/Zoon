...
struct VoiceJournalView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("Audio is processed on this device and is not saved. The transcript stays here until you copy it into Journal.").font(.subheadline).multilineTextAlignment(.center).foregroundStyle(.secondary)
